...
class GeantTopo(Topo):
    def build(self):
        ...
        try:
            ...
            #  Obtener hosts con IP y switch asociado
            ...
            #  Obtener puertos para conexiones (host-switch y switch-switch)
            ...
            puertos_dict = {}
            for nodo_origen, nodo_destino, puerto_origen_val, puerto_destino_val in puertos_list: 
            ...
            #  Conectar hosts a switches con puerto específico en switch
            for nombre_host, id_switch_asociado, ip, mac in hosts_list:
                ...
                if puerto_destino_en_host is not None:
                    link_kwargs['port1'] = puerto_destino_en_host 
                if puerto_origen_en_switch is not None:
                    link_kwargs['port2'] = puerto_origen_en_switch 
            ...
            #  Obtener enlaces switch-switch con ancho de banda
                ...
                if id_origen in switches and id_destino in switches:
                    ...
                    if puertos is None:
                        ...
                        if puertos_inv is not None:
                            puerto_origen_en_sw = puertos_inv[1]  
                    ...
                    if puerto_origen_en_sw is not None:
                        kwargs['port1'] = puerto_origen_en_sw  
                    if puerto_destino_en_sw is not None:
                        kwargs['port2'] = puerto_destino_en_sw  
